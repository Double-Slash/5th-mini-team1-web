<template>
  <div>
    ...
    :title="item.title" :content="item.content"></IntroCard>
        ...
        <div class="words">하고싶은 말
        <IntroCard v-for="item in items" :key="item.id" class='view-info'
    :title="item.title" :content="item.content"></IntroCard></div>
      </div>
        </div>
  </div>
  <div class="button">
